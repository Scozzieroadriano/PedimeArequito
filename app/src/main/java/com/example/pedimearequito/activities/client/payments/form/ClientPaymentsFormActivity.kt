package com.example.pedimearequito.activities.client.payments.form
...
import com.example.pedimearequito.activities.client.payments.installments.ClientPaymentsInstallmentsActivity
import com.example.pedimearequito.models.Cardholder
...
class ClientPaymentsFormActivity : AppCompatActivity() {
    ...
    var mercadoPagoProvider: MercadoPagoProviders= MercadoPagoProviders()
    ...
    private fun createCardToken() {
        ...
        mercadoPagoProvider.createCardToken(mercadoPagoCardTokenBody)?.enqueue(object: Callback<JsonObject> {
            ...
            override fun onFailure(call: Call<JsonObject>, t: Throwable) {
                Toast.makeText(this@ClientPaymentsFormActivity, "Error: ${t.message}", Toast.LENGTH_LONG).show()
            }
